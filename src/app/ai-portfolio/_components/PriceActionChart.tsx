...
import type { Bar, TradeRow } from "./types";
...
export function PriceActionChart({
  ...
  useEffect(() => {
    ...
    const vwapData: LineData<UTCTimestamp>[] = clean
      .filter((b) => b.vwap != null)
      .map((b) => ({ time: b.t as UTCTimestamp, value: b.vwap as number }));
